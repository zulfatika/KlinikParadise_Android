...
public class KonfirmasiDataActivity extends AppCompatActivity {
    ...
    private TextView nomerPasien, namaPasien, tanggalPemeriksaan, poliTujuan;
    ...
    private void init(){
        ...
        tanggalPemeriksaan  = findViewById(R.id.tglPeriksa);
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (response.body().data.size() != 0) {
                                for (ListJadwalResponse.Jadwal poli : response.body().data) {
                                    spinnerItems.add(new SpinnerItem(poli.id_jadwal, poli.shift_praktek + " (" + poli.jam_praktek + ")"));
                                }
                            }
                        } else {
